 ...
 function setup() {
  ...
  p_side=createSprite(windowWidth/18.5,windowHeight/2+6,15,170);
  p_side.shapeColor="white";

  p1_side=createSprite(windowWidth/32,windowHeight/1.56,75,15);
  p1_side.shapeColor="white";

  p2_side=createSprite(windowWidth/32,windowHeight/2.64,75,15);
  p2_side.shapeColor="white";

  c_side=createSprite(windowWidth/1.05,windowHeight/2+6,15,170);
  c_side.shapeColor="white";

  c1_side=createSprite(windowWidth/1.025,windowHeight/1.56,75,15);
  c1_side.shapeColor="white";

  c2_side=createSprite(windowWidth/1.025,windowHeight/2.64,75,15);
  ...
  go=createSprite(windowWidth/2,windowHeight/3.5,10,10);
  go.addImage(go_img);
  go.scale=0.7;
}
...
function draw() {
  ...
  fill(0,0,128);
  textSize(50);
  text(p_score +":" +c_score,windowWidth/2-35,50);
  ...
  if(gameState===end){
    ...
    text("Click the reset button to restart the game",windowWidth/10,windowHeight/1.29);
    reset.visible=true;
  };
